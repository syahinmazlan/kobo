    ...
    if repeat_value and repeat_type then
        ...
        box = ConfirmBox:new{
            ...
            ok_callback = function()
                UIManager:close(box)
                self:setGoal(repeat_value, repeat_type)
            end,
            cancel_text = _("Done"),
        }
        UIManager:show(box)
