...
local USER_CONFIG = {
    ...
    SHOW_GOAL_CLEAN_LOOK     = false,
    SHOW_GOAL_PAGES_SUBTITLE = false,
...
local SETTINGS = {
    ...
    SHOW_GOAL_PROGRESS       = "customisable_ss_show_goal_progress",
    SHOW_GOAL_CLEAN_LOOK     = "customisable_ss_show_goal_clean_look",
    SHOW_GOAL_PAGES_SUBTITLE = "customisable_ss_show_goal_pages_subtitle",
